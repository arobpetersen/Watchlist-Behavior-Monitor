...
OVERVIEW_CACHE_VERSION = 'setup-overview-close-below-be-status-v1'
...
with st.expander('Definitions / Logic', expanded=False):
    st.markdown(
        """
- **Current Status**: current setup state. Active means a trigger-day success has not failed later or closed below breakeven; Later Failed means a successful trigger is no longer above breakeven; Failed D1/D2/D3 means the selected reference low failed after setup day; dash means day-0 fail or unresolved.
