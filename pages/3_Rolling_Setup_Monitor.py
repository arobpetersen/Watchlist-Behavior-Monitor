...
- **VWAP Reclaim**: objective event where a 5-minute bar closes above intraday VWAP between 10:00 and 11:30, then price later takes out that reclaim-bar high. It can display as the trigger when it is successful and tighter than a resolved ORH trigger.
